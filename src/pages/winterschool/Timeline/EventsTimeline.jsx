...
export default class EventsTimeline extends React.Component {
    ...
    week1 = [
        ...
        new EventData("Saturday","Auctionomics Day 1", "Auction Event involving different styles and types of bidding"),
        new EventData("Sunday","Auctionomics Day 2", "Auction Event involving different styles and types of bidding"),
    ]
    week2 = [
        new EventData("Tuesday", "Lecture 3", "Tech and Trading: Past Present and Future"),
        new EventData("Thursday", "Lecture 4", "Life at Optiver and applying for an internship"),
        new EventData("Saturday", "Abstractify: Finals", "Case presentation round"),
